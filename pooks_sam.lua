...
function init_gear_sets()
	...
	sets.engaged.PDT = set_combine(sets.engaged, {body="Emet Harness +1",neck="Twilight Torque",ring2="Patricius Ring",back="Shadow Mantle"})
	
	sets.engaged.Acc.PDT = set_combine(sets.engaged.Acc, {body="Emet Harness +1"})
