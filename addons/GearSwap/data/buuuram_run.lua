...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",
            head=HerculeanHelm.Nuke,neck="Voltsurge Torque",ear1="Loquacious Earring",ear2="Etiolation Earring",
            body="Vrikodara Jupon", hands="Leyline Gloves",ring1="Weather. Ring",ring2="Rahab Ring",
            waist="Twilight Belt",legs="Aya. Cosciales +1",feet="Carmine Greaves"}
    ...
    sets.precast.WS['Resolution'] = {ammo="Seething Bomblet",
            ...
            body=HerculeanVest.CritDmg, hands=HerculeanGloves.WSD,ring1="Epona's Ring",ring2="Rajas Ring",
            back="Ogma's Cape", waist="Fotia Belt",legs=HerculeanLegs.Crit,feet=HerculeanFeet.WSD}
    ...
    sets.precast.WS['Dimidiation'].Acc = set_combine(sets.precast.WS['Dimidiation'].Normal, 
        {ammo="Honed Tathlum", head="Adhemar Bonnet", hands="Buremte Gloves", back="Evasionist's Cape", waist="Thunder Belt"})
    ...
    sets.midcast['Enhancing Magic'] = {waist="Olympus Sash",legs="Carmine Cuisses +1"}
    ...
    sets.midcast.Cure = {neck="Colossus's Torque",ear1="Mendi. Earring",
        body="Vrikodara Jupon",hands="Buremte Gloves",ring1="Ephedra Ring",ring2="Ephedra Ring",
        back="Solemnity Cape",waist="Luminary Sash",legs="Carmine Cuisses +1",feet="Futhark Boots +1"}

    sets.midcast['Flash'] = {ring1="Apeile Ring",ring2="Apeile Ring +1"}
    ...
    sets.idle = {ammo='Homiliary',
            ...
            body="Runeist Coat +1", hands=HerculeanGloves.Refresh, ring1="Defending Ring", ring2="Gelatinous Ring +1",
    ...
    sets.engaged = {sub="Pole Grip",ammo="Ginsen",
            head="Adhemar Bonnet", neck="Lissome Necklace", ear1="Bladeborn Earring", ear2="Steelflash Earring",
            body="Adhemar Jacket", hands="Adhemar Wristbands", ring1="Epona's Ring", ring2="Petrov Ring",
            back="Ogma's Cape", waist="Windbuffet Belt +1", legs=Samnuha.TP, feet=HerculeanFeet.TA}

    sets.engaged.Acc = set_combine(sets.engaged.DD, {sub="Tzacab Grip", ammo="Honed Tathlum", head="Adhemar Bonnet",
    ...
    sets.engaged.PDT = {ammo="Aqreqaq Bomblet",
            ...
            back="Ogma's Cape", waist="Flume Belt", legs="Runeist Trousers +1", feet="Iuitl Gaiters +1"}

    sets.engaged.MDT = {
            head="Futhark Bandeau +1", neck="Twilight Torque", ear1="Etiolation Earring", ear2="Sanare Earring",
            body="Futhark Coat +1", hands="Umuthi Gloves", ring1="Dark Ring", ring2="Dark Ring",
