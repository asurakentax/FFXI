...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Thew Bomblet",
        ...
        body=HerculeanVest.CritDmg,hands=HerculeanGloves.TP,ring1="Hetairoi Ring",ring2="Epona's Ring",
        back="Canny Cape",waist="Fotia Belt",legs=HerculeanLegs.Crit,feet=HerculeanFeet.CritDmg}
    ...
    sets.idle = {ammo="Inlamvuyeso",
        head="Pillager's Bonnet +1",neck="Twilight Torque",ear1="Genmei Earring",ear2="Infused Earring",
        body="Emet harness +1",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Vertigo Ring",
        back="Solemnity Cape",waist="Flume Belt",legs="Pillager's Culottes +1",feet="Skadi's Jambeaux +1"}
    ...
    sets.engaged = {ammo="Ginsen",
        ...
        back="Canny Cape",waist="Windbuffet Belt +1",legs=HerculeanLegs.TP,feet=HerculeanFeet.TA}
