...
function init_gear_sets()
    ...
    sets.precast.FC = {head="Carmine Mask",neck="Voltsurge Torque",ear1="Loquac. Earring",ring1="Prolix Ring",
        waist="Goading Belt",feet="Odyssean Greaves"}
    ...
    sets.midcast.Enmity = {ammo="Paeapua",
        head="Souveran Schaller",neck="Invidia Torque",
        body="Souveran Cuirass",hands="Reverence Gauntlets +1",ring1="Apeile Ring",ring2="Apeile Ring +1",
    ...
    sets.midcast.Cure = {ammo="Hydrocera",
        head="Souveran Schaller",neck="Invidia Torque",ear1="Nourish. Earring",ear2="Bloodgem Earring",
        body="Souveran Cuirass",hands="Macabre Gauntlets",ring1="Kunaji Ring",ring2="Asklepian Ring",
        back="Fierabras's Mantle",waist="Rumination Sash",legs="Souveran Diechlings",feet="Odyssean Greaves"}
    ...
    sets.idle = {ammo="Vanir Battery",
        head="Valorous Mask",neck="Twilight Torque",ear1="Thureous Earring",ear2="Cryptic Earring",
        body="Souveran Cuirass",hands="Souveran Handschuhs",ring1="Defending Ring",ring2="Succor Ring",
        back="Mubvum. Mantle",waist="Fucho-no-obi",legs="Souveran Diechlings",feet="Souveran Schuhs"}
    ...
    sets.defense.PDT = {ammo="Paeapua",
        head="Souveran Schaller",neck="Twilight Torque",ear1="Thureous Earring",ear2="Cryptic Earring",
        body="Souveran Cuirass",hands="Souveran Handschuhs",ring1="Defending Ring",ring2="Succor Ring",
        back="Mubvum. Mantle",waist="Creed Baudrier",legs="Souveran Diechlings",feet="Souveran Schuhs"}
