...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {head="Lanun Tricorne +1",neck="Twilight Torque",ear1="Genmei Earring",
    body="Lanun Frac +1",hands="Chasseur's Gants +1",ring1="Barataria Ring",ring2="Luzaf's Ring",
    back="Camulus's Mantle",waist="Flume Belt",legs="Carmine Cuisses +1",feet="Lanun Bottes +1"}
    ...
    sets.precast.FC = {head=HerculeanHelm.Nuke,neck="Voltsurge Torque",ear1="Etiolation Earring",ear2="Loquacious Earring",
        hands="Leyline Gloves",ring1="Rahab Ring",ring2="Weather. Ring",
        waist="Twilight Belt",Legs="Carmine Cuisses +1",feet="Carmine Greaves"}
    ...
    sets.precast.WS = {
        ...
        body=HerculeanVest.CritDmg,hands=HerculeanGloves.Crit,ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Fotia Belt",legs={name="Herculean Trousers", augments={'Attack+22','Crit. hit damage +4%','Accuracy+9',}},feet=HerculeanFeet.WSD}
    ...
    sets.precast.WS['Last Stand'] = {ammo=gear.WSbullet,
        head="Whirlpool Mask",neck="Fotia Gorget",ear1="Clearview Earring",ear2="Moonshade Earring",
        body="Laksamana's Frac",hands="Iuitl Wristbands",ring1="Rajas Ring",ring2="Stormsoul Ring",
        back="Terebellum Mantle",waist="Fotia Belt",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}

    sets.precast.WS['Last Stand'].Acc = {ammo=gear.WSbullet,
        head="Laksamana's Hat",neck="Fotia Gorget",ear1="Clearview Earring",ear2="Moonshade Earring",
        body="Laksamana's Frac",hands="Buremte Gloves",ring1="Hajduk Ring",ring2="Stormsoul Ring",
        back="Libeccio Mantle",waist="Fotia Belt",legs="Thurandaut Tights +1",feet="Laksamana's Bottes"}
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
        ...
        back="Toro Cape",waist="Fotia Belt",legs="Iuitl Tights",feet="Iuitl Gaiters +1"}
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        body="Emet Harness +1",hands=HerculeanGloves.Refresh,ring1="Defending Ring",ring2="Vertigo Ring",
        back="Solemnity Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet=HerculeanFeet.Idle}
    ...
    sets.engaged.Melee = {ammo=gear.RAbullet,
        ...
        body="Adhemar Jacket",hands=HerculeanGloves.TP,ring1="Petrov Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Windbuffet Belt +1",legs=HerculeanLegs.TP,feet=HerculeanFeet.TA}
